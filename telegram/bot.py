...
HOSTNAME = "https://600c-147-83-201-134.ngrok-free.app"
...
def cmd_start(message):
    ...
    p = subprocess.Popen(["python3", "./restb.aiAPI.py", codi, m2] + names, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
